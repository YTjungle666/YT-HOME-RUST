...
echo ========================================
echo YT HOME Windows Uninstaller
echo ========================================
...
echo Uninstalling YT HOME from: %INSTALL_DIR%
...
if exist "%DESKTOP%\YT HOME.lnk" (
    del "%DESKTOP%\YT HOME.lnk" >nul 2>&1
    echo Desktop shortcut removed
)

REM Remove Start Menu shortcut
echo Removing Start Menu shortcut...
set "START_MENU=%APPDATA%\Microsoft\Windows\Start Menu\Programs\YT HOME"
if exist "%START_MENU%" (
...
netsh advfirewall firewall delete rule name="YT HOME Panel" >nul 2>&1
netsh advfirewall firewall delete rule name="YT HOME Subscription" >nul 2>&1
...
echo ========================================
echo.
echo YT HOME has been uninstalled from your system.
echo.
if /i "%keep_data%"=="y" (
...
echo.
echo Thank you for using YT HOME!
echo.
pause
